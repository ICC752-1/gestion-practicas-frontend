...
const STATUS_CONFIG = {
  ...
  2: { label: 'Aprobado', color: 'text-green-500', bg: 'bg-green-50', icon: CheckCircle2 },
  3: { label: 'Rechazado', color: 'text-red-500', bg: 'bg-red-50', icon: AlertCircle },
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2 mt-auto">
              ...
              {canDelete && doc.status_id !== 2 && doc.status_id !== 4 && (
                <button
