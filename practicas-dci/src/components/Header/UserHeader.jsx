  ...
  return (
    <header className="flex w-full items-center justify-between px-10 h-20 bg-white border-b-[3px] border-[#b13168] z-50 shadow-sm sticky top-0">
      ...
      <nav className="hidden md:flex items-center gap-8">
        <a href="#" className="font-bold text-[#b13168] hover:opacity-80 transition-opacity">
      ...
      <div className="flex items-center gap-6">
        ...
        <button className="p-2 text-[#b13168] hover:bg-red-50 hover:text-red-600 rounded-lg transition-all" title="Cerrar Sesión">
